...
最後に重要な指示を繰り返します。結果はかならず適切なフォーマットのJSON文字列にしてください。カンマや括弧が足りないなどの不整合があってはいけません`,
  '/video':
...
${!params.context ? '' : `<考慮して欲しいこと>${params.context}</考慮して欲しいこと>`}
...
<output></output>`;
    else return diagramSystemPrompts[params.diagramType!] || diagramSystemPrompts.FlowChart;
  },
};
