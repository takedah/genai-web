...
---
  ...
  return (
    <>
      ...
      <form
        className='flex flex-col gap-8 p-4 border border-solid-gray-700 rounded-12 lg:p-6'
      ...
      >
        ...
        <div>
          ...
          {conversationHistory && (
            <div className='flex flex-col gap-4'>
              <Disclosure className='border-b border-b-solid-gray-536'>
                <DisclosureSummary className='w-full py-2'>会話履歴</DisclosureSummary>
                <pre className='my-2 border border-transparent bg-solid-gray-50 px-3 text-dns-14N-130 leading-140 wrap-break-word whitespace-pre-wrap'>
                  {conversationHistory}
                </pre>
              </Disclosure>
            </div>
