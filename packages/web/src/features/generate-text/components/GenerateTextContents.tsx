...
export const GenerateTextContents = () => {
  return (
    <div className='py-4 lg:py-6'>
        ...
        <Disclosure className='my-4'>
          ...
          <div className='pl-7'>
            <p>
              ...
              4.5）の機能を活用し、文章の元になる情報および文章の形式に入力された情報を元に文章を生成するよう入力プロンプトに指示し、生成AIが生成した文章を返答させています。特別な文書は読み込ませていません。実行環境はAWSのBedrockを利用しています。
            </p>
          </div>
        </Disclosure>
      </div>
      <div className='text-center mt-8'>
        <Button variant='outline' size='lg' asChild>
          <Link to='/generate/invoke'>このアプリを使う</Link>
        </Button>
      </div>
    </div>
  );
