    ...
    <div className='rounded-16 border border-solid-gray-536 bg-solid-gray-50 px-8 py-6 text-solid-gray-800 xl:px-10 xl:py-6'>
      ...
      <dl className='flex flex-col gap-4 xl:gap-6'>
        ...
        <div>
          ...
          <dd>
            資料や文書をファイルに添付してAIに質問できます（1ファイルあたり4.5MBまで。ただし、PDFのみ15MBまで添付できます。Base64エンコード後のサイズで、元のサイズより約1.3倍大きくなります）。文書の要約・翻訳・分析など、ファイルの内容を踏まえた詳細な回答が得られます。対応形式はJPEG/PNG/WebP/GIF形式の画像、PDF/テキスト/CSV/HTML/Markdown/Word/Excel形式のドキュメントです。
          </dd>
        </div>
      </dl>
    </div>
