...
export const TranscribeContents = () => {
  return (
    <div className='py-4 lg:py-6'>
      <div className='prose prose-sm max-w-full'>
        ...
        <Disclosure className='my-4'>
          ...
          <div className='pl-7'>
            <p>
              生成AIの機能を活用し、音声ファイルを文字起こしするよう入力プロンプトに指示して文章を返答させています。特別な文書は読み込ませていません。実行環境はAWSのBedrockを利用しています。
            </p>
          </div>
        </Disclosure>
      </div>
      <div className='text-center mt-8'>
        <Button variant='outline' size='lg' asChild>
          <Link to='/transcribe/invoke'>このアプリを使う</Link>
        </Button>
      </div>
    </div>
  );
