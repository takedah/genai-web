...
interface ImportMetaEnv {
  ...
  readonly VITE_APP_EMAIL_MFA_REQUIRED: string;
  readonly VITE_APP_PASSWORD_POLICY: string;
  readonly VITE_APP_VERSION: string;
  readonly VITE_APP_MODEL_REGION: string;
  readonly VITE_APP_MODEL_IDS: string;
  readonly VITE_APP_DEFAULT_MODEL_ID: string;
  ...
  readonly VITE_APP_RECENTLY_USED_APPS_ENABLED: string;
