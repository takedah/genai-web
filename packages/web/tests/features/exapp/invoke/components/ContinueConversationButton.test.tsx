...
import { ContinueConversationButton } from '../../../../../src/features/exapp/invoke/components/ContinueConversationButton.tsx';

vi.mock('../../../../../src/features/exapp/invoke/stores/useExAppInvokeStore.ts');
vi.mock('../../../../../src/features/exapp/invoke/hooks/useExAppInvokedHistories.ts');
...
describe('ContinueConversationButton', () => {
  ...
  beforeEach(async () => {
    ...
    const historiesModule = await import(
      '../../../../../src/features/exapp/invoke/hooks/useExAppInvokedHistories.ts'
    );
