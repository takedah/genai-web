...
import { ExAppResult } from '../../../../../src/features/exapp/invoke/components/ExAppResult.tsx';

vi.mock('../../../../../src/features/exapp/invoke/stores/useExAppInvokeStore.ts');
vi.mock(
  '../../../../../src/features/exapp/invoke/components/ContinueConversationButton.tsx',
  () => ({
...
describe('ExAppResult', () => {
  ...
  beforeEach(async () => {
    ...
    const module = await import(
      '../../../../../src/features/exapp/invoke/stores/useExAppInvokeStore.ts'
    );
  ...
  it('renders loading state', () => {
    ...
    const loadingIndicator = getByRole('progressbar', { name: '読み込み中' });
  ...
  it('renders copy button when result exists', () => {
    ...
    const button = getByRole('button', { name: '出力結果をコピー' });
