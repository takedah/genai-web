...
export class CommonWebAcl extends Construct {
  ...
  constructor(scope: Construct, id: string, props: CommonWebAclProps) {
    ...
    const hasAllowedIpV4 =
      props.allowedIpV4AddressRanges && props.allowedIpV4AddressRanges.length > 0;
    const hasAllowedIpV6 =
      props.allowedIpV6AddressRanges && props.allowedIpV6AddressRanges.length > 0;
    ...
    const logGroup = new LogGroup(this, `WafLogGroup${id}`, {
      logGroupName: `aws-waf-logs-genai-${props.appEnv}`,
    ...
    new CfnLoggingConfiguration(this, `WafLoggingConfiguration${id}`, {
